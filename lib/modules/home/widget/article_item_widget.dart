...
class ArticleItemWidget extends StatelessWidget {
  ...
  const ArticleItemWidget(
      {this.model, this.index, this.isTopArt = false, Key? key})
      : super(key: key);

  activityIndicator(double size) {
    return SizedBox(
      width: size,
      height: size,
                    ...
                    children: <Widget>[
                      ClipOval(
                        child: CachedNetworkImage(
                          imageUrl:
                              'http://placeimg.com/20/20/${model?.author.hashCode.toString()}${model?.author.toString()}',
                          width: 20,
                          height: 20,
                      ...
                      Padding(
                        ...
                        child: Text(
                          model?.author != null && model?.author != ''
                              ? model?.author ?? ''
                              : model?.shareUser ?? '',
                  ...
                  model?.envelopePic == null || model?.envelopePic == ''
                      ...
                      : Row(
                          ...
                          children: <Widget>[
                            ...
                            CachedNetworkImage(
                              imageUrl:
                                  'http://placeimg.com/60/60/${model?.author.hashCode.toString()}${model?.envelopePic.toString()}',
                              width: 60,
                              height: 60,
                              placeholder: (context, url) =>
                                  activityIndicator(60),
